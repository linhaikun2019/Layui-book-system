...
if(isset($_SESSION['username1'])){
    header("refresh:0;url=Library_index.php");
}
?>
<!DOCTYPE html>
<html>
...
<form class="layui-form" id="login_form" method="post" action="./php/Library_loginuser.php">
  <div class="layui-form-item" style="margin-left: 10px;">
    <label class="layui-form-label" for="uname" style="font-size: 15px;color:#393D49; cursor: pointer;">学号</label>
    <div class="layui-input-block">
      <input type="text" name="uname" id="uname" required  lay-verify="required" lay-reqText="<a style='color:#000000'>学号不能为空！</a>" placeholder="请输入学号" autocomplete="off" maxlength="20" class="layui-input" style="width: 220px;margin: 30px 0 0">
    </div>
  </div>
  <div class="layui-form-item" style="margin-left: 10px;">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      ...
      <a href="Library_register.php" class="layui-btn" id="embed-reg" style="margin: 40px 0 0 20px">注册</a>
    </div>
  </div>
</form>
  <div style="position: fixed;bottom: 5px;margin-left: 90px;"><em>Powered By <a id="author" onclick="layer.open({title: '联系作者',content: '<p style=\'color: #000000;\'>作者QQ：2735982878<br>邮箱：2735982878@qq.com</p>',skin: 'layui-layer-molv',btn: '我知道了',resize: false})">@lhk</a> &nbsp;&nbsp;&nbsp;图书借阅系统</em></div>
</div>
</div>
...
//监听提交
    form.on('submit(login)', function(data){
        if(slider.isOk()){//用作表格验证是否已经滑动成功
            $.ajax({
                type: "POST",//方法
                url: "./php/Library_loginuser.php" ,//表单接收url
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        ...
                        setTimeout(function (){location.href="Library_index.php"},3000);
                    }else if (data == 2) {
