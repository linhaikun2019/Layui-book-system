...
$count = "select * from library_booklend";
$result = mysqli_query($con,$count);
$num = mysqli_num_rows($result);
$count1 = "select * from library_mylend";
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item layui-this"><a href="Library_index.php">首页</a></li>
            <li class="layui-nav-item"><a href="Library_booklend.php">图书借阅</a></li>
            <li class="layui-nav-item"><a href="Library_mylend.php.php">我的图书</a></li>
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 15px;"><h1 style="text-align: center;"><?php echo $_SESSION["username1"]; ?>,欢迎您！</h1><br><p style="text-align: center;font-size: 20px;">馆存图书数量：<?php echo $num; ?><br>已借图书数量：<?php echo $num1; ?></p></div>
    </div>
