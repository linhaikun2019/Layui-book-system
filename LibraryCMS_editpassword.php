...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <form class="layui-form" id="login_form" method="post" action="./php/LibraryCMS_editpwd.php">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <a href="LibraryCMS_index.php" class="layui-btn" id="embed-back" style="margin: 40px 0 0 20px">返回</a>
                </div>
            </div>
            </form>
        </div>
...
<script>
    ...
    layui.use(['element','form','jquery','layer','table','laypage'], function(){
        ...
        form.on('submit(login)', function(data) {
            $.ajax({
                type: "POST",//方法
                url: "./php/LibraryCMS_editpwd.php",//表单接收url
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        ...
                        setTimeout(function (){location.href="LibraryCMS_logout.php"},3000);
                    }
                },
                error: function (data) {
                    //提交失败的提示词或者其他反馈代码
