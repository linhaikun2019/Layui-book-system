...
<form class="layui-form" id="login_form" method="post" action="./php/Library_registeruser.php">
    <div class="layui-form-item" style="margin-left: 10px;">
    <label class="layui-form-label" for="uname" style="font-size: 15px;color:#393D49; cursor: pointer;">学号</label>
    <div class="layui-input-block">
      <input type="text" name="uname" id="uname" required  lay-verify="required" lay-reqText="<a style='color:#000000'>学号不能为空！</a>" placeholder="最多10字符,只允许数字" autocomplete="off" maxlength="20" class="layui-input" style="width: 220px;margin: 30px 0 0">
    </div>
  </div>
  <div class="layui-form-item" style="margin-left: 10px;">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      ...
      <a href="Library_login.php" class="layui-btn" id="embed-log" style="margin: 40px 0 0 20px">登录</a>
    </div>
  </div>
</form>
...
//监听提交
    form.on('submit(login)', function(data){
        if(slider.isOk()){//用作表格验证是否已经滑动成功
            $.ajax({
                type: "POST",//方法
                url: "./php/Library_registeruser.php" ,//表单接收url
                ...
                success: function (data) {
                    ...
                    if (data == 3) {
                        ...
                        setTimeout(function (){location.href="Library_login.php"},3000);
                    }
                },
                error : function(data) {
                    //提交失败的提示词或者其他反馈代码
